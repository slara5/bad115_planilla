          ...
          <tbody>
            <?php foreach ($detalles as $index => $detalle) : ?>
              <tr>
                ...
                <td><?= $tablaRentaModel->get($detalle['ID_TABLA'])[0]['NOMBRE_TABLA']?></td>
            ...
            <div class="modal-body">
                <form action="<?= $url_guardar ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="DESDE_MONTO_INGRESOS" id="DESDE_MONTO_INGRESOS"  onkeyup="validar_numero(this, 1)" onblur="validar_numero(this, 1)" type="number" class="form-control" placeholder="0.01">
                    ...
                    <div class="form-group">
                        ...
                        <input name="HASTA_MONTO_INGRESOS" id="HASTA_MONTO_INGRESOS"  onkeyup="validar_numero(this, 1)" onblur="validar_numero(this, 1)" type="number" class="form-control" placeholder="0.01">
                        <div class="invalid-feedback" style="display:none">
                        Monto invalido: <strong>Monto debe ser mayor que 1</strong>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="PORCENTAJE_RENTA_TABLA" id="PORCENTAJE_RENTA_TABLA" onkeyup="validar_numero(this, 1,100)" onblur="validar_numero(this, 1,100)" type="number" class="form-control" placeholder="0.01">
                        <div class="invalid-feedback" style="display:none">
                    ...
                    <div class="form-group">
                        ...
                        <input name="LIMITE_MAXIMO_AFP" id="LIMITE_MAXIMO_AFP"  onkeyup="validar_numero(this, 1)" onblur="validar_numero(this, 1)" type="number" class="form-control" placeholder="0.01">
                        <div class="invalid-feedback" style="display:none">
                        Monto invalido: <strong>Monto debe ser mayor que 1</strong>
                        </div>
                    </div>
