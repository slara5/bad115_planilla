                    ...
                    <tbody>
                        <?php foreach ($generos as $index => $generos) : ?>
                            <tr>
                                ...
                                <button type="button" onclick="eliminar(<?= $generos['ID_GENERO'] ?>)" class="btn btn-danger col-5" data-toggle="modal" data-target="#eliminarModal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="generoModalLabel"><?= $nombre_obj?></h5>
            ...
            <div class="modal-body">
                <form action="<?= $url_guardar ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input name="DESCRIPCION_GENERO" id="DESCRIPCION_GENERO" onkeyup="validar_nombre(this)" onblur="validar_nombre(this)" type="text" class="form-control" id="" placeholder="Nombre de <?= $nombre_obj?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content  bg-danger">
      ...
      <form action="<?= $url_eliminar ?>" method="post" class=" mt-4 row d-flex justify-content-around">
          <?= csrf_field() ?>
          <input type="hidden" id="id_eliminar" name="ID_GENERO">
